...
#  }
#  config = {
#    container_name = dependency.remote_state.container_name
#    resource_group_name = dependency.remote_state.resource_group_name
#    storage_account_name = dependency.remote_state.storage_account_name
#
#
